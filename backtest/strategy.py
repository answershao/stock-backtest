...
def run_expected_return_strategy(
    ...
    *,
    ...
    - Fractional shares are allowed to keep the implementation focused on strategy logic.
    ...
    for date in trading_dates:
        ...
        portfolio_rows.append(_capture_portfolio_row(date, prices, holdings, cash))
